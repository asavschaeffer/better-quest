...
const MOCK_FRIENDS_SESSIONS = [
  ...
  },
  {
    ...
    standStats: { INT: 2, SPI: 1, DEX: 0.5 },
    expResult: { totalExp: 1080, standExp: { INT: 780, SPI: 200, DEX: 100 } },
    restBonus: true,
    bonusMultiplier: 1.1,
    bonusBreakdown: [{ key: "rest", label: "Well-rested", mode: "mult", value: 1.1 }],
    notes: "Finally understood recursion!",
  ...
  },
  {
    ...
    standStats: { STR: 2, STA: 1, VIT: 0.5 },
    expResult: { totalExp: 720, standExp: { STR: 520, STA: 120, VIT: 80 } },
    comboBonus: true,
    restBonus: true,
    bonusMultiplier: 1.32,
    bonusBreakdown: [
      { key: "combo", label: "Combo", mode: "mult", value: 1.2 },
      { key: "rest", label: "Well-rested", mode: "mult", value: 1.1 },
    ],
  ...
  },
  {
    ...
    standStats: { INT: 2, CHA: 1, VIT: 0.5 },
...
const MOCK_GLOBAL_SESSIONS = [
  {
    ...
    standStats: { DEX: 2, SPI: 1, VIT: 0.5 },
    expResult: { totalExp: 360, standExp: { DEX: 180, SPI: 110, VIT: 70 } },
    notes: "Morning stretch routine complete 🧘",
    userName: "ZenWarrior",
    userLevel: 27,
  },
  {
  ...
  },
  {
    ...
    standStats: { SPI: 2, INT: 1, CHA: 0.5 },
    expResult: { totalExp: 720, standExp: { SPI: 420, INT: 210, CHA: 90 } },
    notes: "Finished chapter 3 of my novel!",
  ...
  },
  {
    ...
    standStats: { INT: 2, VIT: 1, SPI: 0.5 },
  ...
  },
  {
    ...
    standStats: { INT: 2, SPI: 1, DEX: 0.5 },
    expResult: { totalExp: 1080, standExp: { INT: 780, SPI: 200, DEX: 100 } },
    notes: "Reviewed all the calculus material for the exam.",
    userName: "StudyMaster",
    userLevel: 38,
  },
  {
    ...
    standStats: { STA: 2, STR: 1, VIT: 0.5 },
    expResult: { totalExp: 240, standExp: { STA: 120, STR: 80, VIT: 40 } },
    comboBonus: true,
    bonusMultiplier: 1.2,
    bonusBreakdown: [{ key: "combo", label: "Combo", mode: "mult", value: 1.2 }],
    notes: "Pushed through the final set! 🔥",
