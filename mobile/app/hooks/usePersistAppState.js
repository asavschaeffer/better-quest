  ...
  useEffect(() => {
    const save = async () => {
      await saveAppState({
        ...
        fatigueAdapt: state.fatigueAdapt,
        fatigueAdaptNext: state.fatigueAdaptNext,
        fatigueAdaptDay: state.fatigueAdaptDay,
    ...
    state.fatigueAdapt,
    state.fatigueAdaptNext,
    state.fatigueAdaptDay,
