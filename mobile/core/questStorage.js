...
export const BUILT_IN_QUEST_TEMPLATES = [
  // --- Families (tappable scope nodes). Families can also be startable (generic version). ---
  {
    id: "study",
    label: "Study",
    description: "Learn and review something intentionally",
    defaultDurationMinutes: 25,
    stats: { STR: 0, DEX: 0, STA: 0, INT: 2, SPI: 0, CHA: 0, VIT: 1 },
    // Search discovery only (not hierarchy)
    keywords: ["study", "learn", "review", "homework", "exam"],
    tags: ["study", "learn", "review", "teach"],
    // Hierarchy
    verb: "study",
    parentId: null,
    isFamily: true,
...

  {
    id: "math",
    label: "Study Math",
    description: "Study math (problem sets, courses, drills)",
    defaultDurationMinutes: 60,
    stats: { STR: 0, DEX: 0, STA: 0, INT: 2, SPI: 0, CHA: 0, VIT: 1 },
    keywords: ["math", "calculus", "algebra", "geometry", "study"],
    tags: ["study", "math", "calculus", "algebra", "geometry"],
    verb: "study",
    parentId: "study",
    isFamily: false,
    isStartable: true,
  ...
  },
  {
    id: "science",
    label: "Study Science",
    description: "Study science (biology, chemistry, physics)",
    defaultDurationMinutes: 45,
    stats: { STR: 0, DEX: 1, STA: 0, INT: 2, SPI: 0, CHA: 0, VIT: 1 },
    keywords: ["science", "physics", "chemistry", "biology", "research"],
    tags: ["study", "science", "biology", "chemistry", "physics", "research"],
    verb: "study",
    parentId: "study",
    isFamily: false,
    isStartable: true,
  ...
  },
  {
    id: "writing",
    label: "Write",
    description: "Write (notes, summary, reflection, journal)",
    defaultDurationMinutes: 30,
    stats: { STR: 0, DEX: 0, STA: 0, INT: 1, SPI: 2, CHA: 0, VIT: 1 },
    keywords: ["writing", "journal", "essay", "blog", "article"],
    tags: ["write", "writing", "journal", "notes", "summary", "reflect"],
    verb: "write",
    parentId: null,
    isFamily: true,
    isStartable: true,
  ...
  },
  {
    id: "reading",
    label: "Read a Book",
    description: "Read a book, chapter, or longer-form text",
    defaultDurationMinutes: 30,
    stats: { STR: 0, DEX: 0, STA: 0, INT: 2, SPI: 1, CHA: 0, VIT: 1 },
    keywords: ["reading", "book", "novel", "article", "study"],
    tags: ["read", "reading", "book", "novel", "study"],
    verb: "read",
    parentId: "read",
    isFamily: false,
    isStartable: true,
  ...
  },
  {
    ...
    description: "Build or ship a small piece of software",
    defaultDurationMinutes: 45,
    stats: { STR: 0, DEX: 1, STA: 0, INT: 2, SPI: 0, CHA: 0, VIT: 1 },
    keywords: ["code", "coding", "programming", "debugging", "software"],
    tags: ["coding", "code", "programming", "build", "feature"],
    verb: "build",
    parentId: "coding-family",
    isFamily: false,
    isStartable: true,
    action: null,
    icon: "code-slash-outline",
  ...
  },
  {
    id: "debug",
    label: "Debug a Bug",
    description: "Fix one annoying bug end-to-end",
    defaultDurationMinutes: 30,
    stats: { STR: 0, DEX: 2, STA: 0, INT: 2, SPI: 0, CHA: 0, VIT: 1 },
    keywords: ["debug", "bug", "fix", "error", "stack trace", "coding"],
    tags: ["debug", "bug", "fix", "coding", "software"],
    verb: "repair",
    parentId: "coding-family",
    isFamily: false,
    isStartable: true,
  ...
  // --- Hybrids (single canonical parent; ranking surfaces them when stats align) ---
  {
